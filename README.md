...
- 🎨 **대시보드형 UI/UX**: 스포티하고 트렌디한 카드·그리드 레이아웃
...
- 🔍 **지표 툴팁**: WAR·OPS·ERA 등 전문용어에 ? 아이콘 툴팁 제공
...
- 선수 유형(타자/투수), 연도, 팀, 선수 선택
- 선택한 선수의 지표(WAR/OPS/ERA/FIP/IP 등) 시즌별 라인 차트
- 하단 시즌별 상세 테이블(필터 기반, 더보기 로드)

### 5. 홈 페이지 (`/`)

- 전체 팀 순위/전력 추이, Total WAR, 최신 스냅샷
